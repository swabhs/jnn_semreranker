...
public class FspRerankerAppTest {
    ...
    // FrameSemParse frame1 = new FrameSemParse("BANKER", 2, 2, "banker.n", "banker",
    // Sets.newHashSet(arg1), 1.5);
    // FrameSemParse frame2 = new FrameSemParse("STOCK", 5, 5, "stocks.n", "stocks",
    // Sets.newHashSet(arg2, arg3),
    // 1.3);
    // FrameSemParse frame3 = new FrameSemParse("BUY", 5, 5, "purchases.v", "purchases",
    // Sets.newHashSet(arg4,
    // arg5), 2.0);
    // FrameSemParse frame4 = new FrameSemParse("STOCK", 5, 5, "stocks.n", "stocks",
    // Sets.newHashSet(arg2), 0.8);
    // FrameSemParse frame5 = new FrameSemParse("BUY", 5, 5, "purchases.v", "purchases",
    // Sets.newHashSet(arg4),
    // 1.0);
    //
